...
<body>
    ...
    <div class="header">
        <div class="main">
            <h1>“ Follow your passion in Music ”</h1>
            <p>Welcome to the Music Scales(MS),
    ...
    <div class="lessons_we_offer">
        <h1>Lessons We Offer</h1>
        <p>Users can easily learn with proper guidance, by simply following
    ...
    <div class="ptopics">
        ...
        <p>No doubt Guitar & Piano are the most popular
            <br>musical instruments that has attracted many individuals around the world.
            <br>A lot of people have a desire to learn these popular instruments.
        </p>
        <div class="row">
            <div class="popular">
    ...
    <div class="our_services">
        <h1>Our Services</h1>
        <p>Learn music online through the Music Scales.
            <br>Register for online music lessons. Join us today to Improve your Skills.
        </p>
        <div class="row">
            <div class="services">
    ...
    <div class="contact">
        <h1>Have Any Comments, Feedback ?</h1>
